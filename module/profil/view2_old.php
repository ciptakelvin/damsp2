            ...
            <div class="card card-primary">
			  ...
			  ?>
			  	<tr><td><?php  echo $no;?></td>
					...
					<td><?php  echo $data3['kegiatan'];?></td>
				<?php
					$query4 = "select count(id_realisasi) jml_real from realisasi_rki where id_keg ='".$data3['id_rkipeg']."' and val='1' and status ='1'";
					$run4 = mysqli_query($konek,$query4);
					$data4 = mysqli_fetch_array($run4);
				?>
					<td><?php  echo $data4['jml_real'];?></td>
					<td><?php  if($data3['val'] == 0){ echo "Belum Validasi"; } else { echo "Sudah Validasi";} ?></td>
					<td>
						<?php if($data3['val']== 1 ) { ?>					
