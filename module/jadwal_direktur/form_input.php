        ...
        <div class="row">
          ...
          <div class="col-md-12">
			...
			<div class="card-header">
                <h3 class="card-title">Form Input Kegiatan Pejabat </h3>
              </div>
			  <div class="card-body ">
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="module/jadwal_direktur/proses.php" method="post">
			<table class="col-md-12 form-control-sm">
				...
				<tr><td>Tanggal</td>
					<td><input class="col-md-8 form-control form-control-sm" type="date" name="tanggal" placeholder="yyyy/mm/dd" required></td>
				</tr>
				<tr><td>Waktu Mulai</td>
					<td><input class="col-md-8 form-control form-control-sm" type="time" name="waktu_mulai" placeholder="Masukan Jam Mulai" required></td>
				</tr>
				<tr><td>Waktu Selesai</td>
					<td><input class="col-md-8 form-control form-control-sm" type="time" name="waktu_selesai" placeholder="Masukan Jam Selesai" required></td>
				</tr>
				<tr><td>Tempat</td>
