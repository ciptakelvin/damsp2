          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><h3 class="card-title">Surat Tugas Direktur mana</h3>
              </div>
			  <div class="card-body">
              ...
              <form role="form" action="module/st_direktur/proses_edit.php" method="post">
				<input type="text" name="id_rko" value="<?php echo $id_rko; ?>">
				<input type="text" name="id_uraian" value="<?php echo $id_uraian; ?>">
