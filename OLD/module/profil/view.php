            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item form-control-sm"><a class="nav-link" href="#settings" data-toggle="tab">Profil</a></li>
                  <li class="nav-item form-control-sm"><a class="nav-link" href="#password" data-toggle="tab">Password</a></li>
                </ul>
              </div>
              <div class="card-body">
