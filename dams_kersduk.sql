...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2021 at 09:02 AM
...
INSERT INTO `id_seksi` (`id_sie`, `seksi`) VALUES
...
(25, 2, 1, 'Pemeliharaan Aplikasi Pendukung Pemeriksaan', 1),
(26, 2, 1, 'Pengembangan Aplikasi Daily Activity Monitoring Systems lingkup Subdit', 1),
...
INSERT INTO `pegawai` (`id_peg`, `nip9`, `nip18`, `nama`, `panggil`, `panggol`, `id_sie`, `motivasi`, `email`, `wa`, `pass`, `gambar`, `jabatan`, `status`) VALUES
...
(4, '830602440', '19910323 201411 1 001', 'FIKRIY AMRULLAH HAKIM', '', 'Pengatur Tk.I/Iid', 1, '', '', '', '830602440', '830602440.jpg', 'Pelaksana', '1'),
...
(11, '910223143', '19940420 201502 2 002', 'ZESSYCA YASMIN ANGGRAINI', '', 'Pengatur Muda Tk.I/IIb', 3, '', '', '', '910223143', '910223143.jpeg', 'Pelaksana', '1'),
...
(14, '921101909', '19920923 201402 2 002', 'ADE ILHAMIA', 'ade', 'Pengatur Tk.I/IId', 2, 'Homebase Medan', 'ade.ilhamia@gmail.com', '081311762359', 'Aze121217', '921101909.jpg', 'Pelaksana', '1'),
...
(16, '910222988', '19950816 201502 1 003', 'EDWARD CORNELIUS BONKEY MANIK', 'Edu', 'Pengatur Muda Tk.I/IIb', 2, 'hidup sehat, mati masuk surga', 'eduardo.cbm@gmail.com', '082167628821', '910222988', '910222988.jpg', 'Pelaksana', '1'),
...
(23, '830601272', '199108112013101003	', 'DAVID GILANG DWI LAKSONO', 'DAVID ', 'Pengatur Tk.I/IId', 2, '', 'davidgilang.dwi@pajak.go.id', '', '830601272', '', 'Pelaksana', '1'),
(24, '817930647', '199702212018012002 ', 'FIKA ASTRIA', '', 'Pengatur/IIc', 2, '', '', '', '817930647', '', 'Pelaksana', '1'),
(25, '817930435', '199608092018011002', 'ADITYA RANGGA PRASETYO', '', 'IIc', 2, '', '', '', '817930435', '', 'Pelaksana', '1'),
(26, '917338436', '199508212018012001', 'RIZKA NADHILA AUZI', 'sayang', '', 2, '', '', '', '917338436', 'avatar2.JPG', 'Pelaksana', '1');
...
(1, 1, 1, 'WULANDARI YULI ASTUTI', '19800720 200002 2 00', '1', 1),
(2, 1, 17, 'ARIF WIBAWA', '197101281990121001	', '1', 1),
(3, 1, 13, 'IFANDI SYAMSIR', '19820407 200312 1 00', '2', 1),
(4, 1, 18, 'WISHNU AGUNG BAROTO', '198208062002121002	', '2', 1),
(11, 1, 5, 'NOOR CHYTTA AMANDA PUTRYANZI', '19911111 201402 2 00', '1', 1),
(12, 3, 18, 'WISHNU AGUNG BAROTO', '198208062002121002	', '2', 1),
(13, 3, 15, 'FAIZAL NUR ACHMAD FIRMANSYAH', '19950104 201502 1 00', '2', 1),
...
(4, 'ND-123/PJ.00/2020', '2020-03-11', 'Kersduk', 'Rapat Pembinaan', 'Ruang Cakti Lt 15', '2020-03-13', '', 1, '', 1);
...
(1, 'ST-194/PJ.04/2020', '2020-12-15', '2020-03-09', '0000-00-00', 'KPP di WIlayah Jakarta', 'Piloting dan Implementasi Aplikasi Desktop Pemeriksaan', 1),
(2, 'a2', '2020-12-12', '2020-12-12', '2020-12-12', 'a', 'a', 0),
(3, 'ST-001/PJ.04/2020', '2020-12-21', '0000-00-00', '0000-00-00', 'Jakarta', 'Diseminasi DAMS', 0),
(4, 'ST-002/PJ.04/2020', '2020-12-21', '2020-12-21', '2020-12-23', 'Jakarta', 'Diseminasi DAMS', 1),
(5, 'ST 1', '2021-01-08', '2021-01-10', '2021-01-15', 'Medan', 'Sosialisasi', 1);
...
--
ALTER TABLE `pegawai`
  MODIFY `id_peg` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `pegawai_tugas`
--
ALTER TABLE `pegawai_tugas`
  MODIFY `id_pegst` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `rapat_subdit`
--
ALTER TABLE `rapat_subdit`
  MODIFY `id_rp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `surat_tugas`
  MODIFY `id_st` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
